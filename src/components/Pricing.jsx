        ...
        <div name='pricing' className='w-full text-white my-24'>
            ...
            <div className='max-w-[1240px] mx-auto py-12'>
                <div className='text-center py-8 text-slate-300'>
                    ...
                    <p className='text-5xl font-bold text-white py-8'>The right price for your research</p>
                    <p className='text-3xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsam non quae aliquam culpa neque quod, mollitia hic perferendis beatae. Beatae.</p>
                </div>
