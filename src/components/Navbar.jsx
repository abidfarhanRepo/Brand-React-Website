    ...
    return (
        <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
                ...
                <li className='border-b-2 border-zinc-300 w-full cursor-pointer'>
                    <Link to='about' smooth={true} offset={-200} duration={500} onClick={handleClose}>About</Link>
                </li>
                <li className='border-b-2 border-zinc-300 w-full cursor-pointer'>
                    <Link to='support' smooth={true} offset={-50} duration={500} onClick={handleClose}>Support</Link>
                </li>
                <li className='border-b-2 border-zinc-300 w-full cursor-pointer'>
                    <Link to='platforms' smooth={true} offset={-100} duration={500} onClick={handleClose}>Platforms</Link>
                </li>
                <li className='border-b-2 border-zinc-300 w-full cursor-pointer'>
                    <Link to='pricing' smooth={true} offset={-50} duration={500} onClick={handleClose}>Pricing</Link>
                </li>
